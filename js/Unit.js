...
function unitClass(type) {
    ...
    */
    ...
    this.gotoNear = function(aroundX, aroundY, formationPos=1, formationDim=1) {
        if (!formationDim) { formationDim = 1; }
        if (PATHFINDING_DEBUG_LOG) console.log("gotoNear "+Math.round(aroundX)+","+Math.round(aroundY)+" for unit:"+this.iD+" which is at "+Math.round(this.x)+","+Math.round(this.y));
    ...
    this.move = function() {
        ...
        if(this.tilePath.length>0){
          ...
          //        console.log("At enemy HQ with this focus: "+this.focus);
                    ...
                    if(this.focus == "trees"){
                        var nearestTreeFoundForPeasant = findClosestUnitInRange(this.x, this.y, UNIT_AI_TREE_RANGE, trees);
                    ...
                    if(this.focus == "mines"){
                        var nearestMineFoundForPeasant = findClosestUnitInRange(this.x, this.y, UNIT_AI_MINE_RANGE, mines);
    ...
    this.returnResource = function() {
        ...
        if (this.lumber > 0) {
            ...
            if(this.lumber == 0){ //dropped off last piece of lumber
              ...
              var nearestTreeFound = findClosestUnitInRange(this.x, this.y, UNIT_AI_TREE_RANGE, trees);
              this.myTarget = nearestTreeFound;
            }
        }
        else if (this.food > 0) {
